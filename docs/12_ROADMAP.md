...
|----------|-------|-------------------|
| **2026** | Запуск, Product-Market Fit, масштабирование | TVL $50M · 100K пользователей · Multi-EVM + Card On-Ramp |
...
**KPI квартала:** TVL $15M · 25 000 пользователей · Выручка run-rate $2M/год
